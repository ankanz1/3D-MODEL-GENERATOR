...
export default function Rodin() {
  ...
  return (
    <div className="relative h-[100dvh] w-full bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] before:from-transparent before:via-transparent before:to-black/20 before:bg-[length:20px_20px] before:bg-[linear-gradient(45deg,_rgba(255,255,255,0.1)_25%,_transparent_25%,_transparent_50%,_rgba(255,255,255,0.1)_50%,_rgba(255,255,255,0.1)_75%,_transparent_75%,_transparent)]">
      {/* Full-screen canvas */}
